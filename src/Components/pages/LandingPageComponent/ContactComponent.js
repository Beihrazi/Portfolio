      ...
      <div className="container">
        <div className="row">
          <div className="top  flex center-center ">
            <div className="top-heading flex center-center  col-1-5">
              <h1 className="sub-heading font-regular  gradient-t-m" style={{
                paddingTop: "13px"
              }}>
                Get in
              </h1>
              <h1 className="regular gradient-t-w">Touch</h1>
            </div>
          </div>
          <div className="bottom flex ">
            <div className="left flex center-center">
              <div className="content color-white">
                <div className="phone flex bor-b">
                  ...
                  <div className="flex right-center">
                    <p className="font-regular tiny">+91-7005836771</p>
                  </div>
                </div>
                <div className="email flex bor-b">
                  <div className="icon flex center-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  <div className="flex center-center">
                    <p className="font-regular tiny">beihrazi@gmail.com</p>
                  </div>
                </div>
                <div className="address flex bor-b">
                  <div className="icon flex center-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  <div className="flex center-center">
                    <p className="font-regular tiny">Banagalore, Karnataka</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="social flex center-center bor-b">
              <div className="top-line-container bor-w">
                <div className="top-line gradient-b-m"></div>
              </div>
              <div className="s-top">
                <h3 className="tiny font-regular color-white">Follow me</h3>
              </div>
              <div className="s-content flex">
                <div className="linkedin flex center-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
                    height="18"
                ...
                <div className="ig flex center-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                ...
                <div className="github flex center-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
