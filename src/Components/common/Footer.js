      ...
      <div className="container">
        <div className="row flex center-center ">
          ...
          <div className="flex center-center ">
            ...
            <div className="go-to-top bor-w flex center-center b-r-50">
              <svg
